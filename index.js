...
client.on("ready", () => {
  ...
  client.user.setPresence({ activity: { name: "NRI ESPORTS" }, status: "dnd" });  // online idle dnd 
});

  client.on("guildMemberAdd", member => {
const myServer = "594871593331851265"; 
const welcomeChannel = "845615925712912394";
...
client.on("message", message => {
    ...
    message.channel.send("hello buddy welcome to nri");
  }

  if(message.content === "!youtube") {
 let embed = new Discord.MessageEmbed()
 .setTitle("youtube OFFICIAL")
 .setDescription("[NRI ESPORTS YOUTUBE OFFICIAL](https://youtu.be/dd2CAWhaHrc)")
 .setColor("#277ECD")
...
message.channel.send(embed);
 ...
 let embed = new Discord.MessageEmbed()
 .setTitle("invite link nri ")
 .setDescription("[tap on me ](https://discord.gg/TubWeJpYdQ)")
 .setColor("#277ECD")
 .setFooter(`Requested by: ${message.author.tag}`, message.author.displayAvatarURL())
 message.channel.send(embed)
}
